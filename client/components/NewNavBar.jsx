...
import { faSearch, faShoppingCart, faHeart, faUser, faCaretDown } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    ...
    {/* <div>NewNavbar</div> */}
        <div className="navbar">
            <div className='top'>
                <a href='' className='top-link'>Store Finder</a>
                <a href='' className='top-link'>Truck & Tool Rental</a>
                <a href='' className='top-link'>For The Pro</a>
                <a href='' className='top-link'>Gift Cards</a>
                <a href='' className='top-link'>Credit Services</a>
                <a href='' className='top-link'>Track Order</a>
                <a href='' className='top-link'>Help</a>
            </div>
            <div className="mid">
                <div className="mid-left">
                    <div className="shopping">
                        <div className="shopping-icon">
                        <img src={"/pics/logo.png"} width="70" height="70" />
                        </div>
                        <div>
                            <p>You're shopping</p>
                            <p className="wichita"><strong>E Wichita</strong>
                            <FaAngleDown className="dropdown-icon" style={{ fontSize: '25px' }} />
                            </p>
            ...
            <div className="bottom">
                <a href='' className="bottom-link">All Departments</a>
                <a href='' className="bottom-link">Home Decor, Furniture & Kitchenware</a>
                <a href='' className="bottom-link">DIY Projects & Ideas</a>
                <a href='' className="bottom-link">Project Calculatus</a>
                <a href='' className="bottom-link">Installation & Services</a>
                <a href='' className="bottom-link">Special & Offers</a>
                <a href='' className="bottom-link">Local Ad & Catalog</a>
            </div>
